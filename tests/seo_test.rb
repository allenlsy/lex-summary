...
site_description = "Concise summaries of one-hour-plus interviews from leading podcasters, led by the Lex Fridman Podcast, with more podcasters to come."
...
assert_includes(home, %(<link rel="canonical" href="https://allenlsy.github.io/lex-tldr/">), "homepage canonical URL is missing")
...
abort "FAIL: homepage schema URL is incorrect" unless home_schema["url"] == "https://allenlsy.github.io/lex-tldr/"
...
assert_includes(english_article, %(<link rel="canonical" href="https://allenlsy.github.io/lex-tldr/articles/94-ilya-sutskever-deep-learning/en/">), "article canonical URL is missing")
assert_includes(english_article, %(hreflang="en" href="https://allenlsy.github.io/lex-tldr/articles/94-ilya-sutskever-deep-learning/en/"), "English hreflang is missing")
assert_includes(english_article, %(hreflang="zh-CN" href="https://allenlsy.github.io/lex-tldr/articles/94-ilya-sutskever-deep-learning/cn/"), "Chinese hreflang is missing")
assert_includes(english_article, %(hreflang="x-default" href="https://allenlsy.github.io/lex-tldr/articles/94-ilya-sutskever-deep-learning/en/"), "default-language alternate is missing")
...
assert_includes(sitemap, "https://allenlsy.github.io/lex-tldr/articles/94-ilya-sutskever-deep-learning/en/", "sitemap omits English article")
assert_includes(sitemap, "https://allenlsy.github.io/lex-tldr/articles/94-ilya-sutskever-deep-learning/cn/", "sitemap omits Chinese article")
abort "FAIL: sitemap includes the noindex search page" if sitemap.include?("https://allenlsy.github.io/lex-tldr/search/")
assert_includes(robots, "Sitemap: https://allenlsy.github.io/lex-tldr/sitemap.xml", "robots.txt does not advertise the sitemap")
